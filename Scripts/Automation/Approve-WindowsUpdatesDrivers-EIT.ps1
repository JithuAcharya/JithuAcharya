...
######## Script ########
# Get date of the next Thursday after the 2nd Tuesday of the month
$today = Get-Date
$firstDayOfNextMonth = Get-Date -Day 1 -Month $today.Month -Year $today.Year
$secondTuesdayOfNextMonth = $firstDayOfNextMonth.AddDays(((9 - $firstDayOfNextMonth.DayOfWeek) % 7) + 7)
$thursdayAfterSecondTuesday = $secondTuesdayOfNextMonth.AddDays(2)
$deploymentDelay = $thursdayAfterSecondTuesday.ToString("yyyy-MM-ddT03:30:00.fffffffzzz")
