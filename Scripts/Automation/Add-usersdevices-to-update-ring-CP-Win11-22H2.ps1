...
######## Variables ########
$appid = "9340ccda-aad0-4fa5-b779-cf1a6f4f2318" # Change me - Target application ID
$targetGroupID = "27f45cfa-d4ff-4c80-8a70-830876211e08" # Change me - Target device group ID
$appVersion = "22H2" # Change me - File name
...
try{
    ...
    Write-Output "Targeted application: $appName"
    ...
    if ($allDevices.count -le 1) {Write-Error "No device found."; exit 1} 
    ...
    Write-Output "Total app page(s): $totalPages"
